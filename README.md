...
**UPD5: Добавлена тестовая сборка для подключения MTProto proxy FakeTLS - [readme-test.md](https://github.com/babayanta1994/autoXRAY/blob/main/test/readme-test.md)** 

**UPD4: Основной скрипт автоматически ставит WARP-cli.** 

**UPD3: Основной и Экспериментальный скрипты объединены, ss2022 удален.** 

**UPD2: Описание неактуальных скриптов перемещено в [oldScriptReadme.md](https://github.com/babayanta1994/autoXRAY/blob/main/old/oldScriptReadme.md).**
...
bash -c "$(curl -L https://raw.githubusercontent.com/babayanta1994/autoXRAY/main/autoXRAY1.sh)" -- вашДОМЕН.com
```
...
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/babayanta1994/autoXRAY/main/autoXRAY1.sh)" -- поддомен1.вашДОМЕН.com

```
2) На ru VPS ставим новый скрипт (здесь нам понадобится vless XHTTP reality EXTRA конфиг №1):
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/babayanta1994/autoXRAY/main/autoXRAYselfRUbrEUxhttp.sh)" -- поддомен2.вашДОМЕН.com "vless://вашКонфигXHTTP"
```
...
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/babayanta1994/autoXRAY/main/old/autoXRAYselfstealConfRUbrEU.sh)" -- поддомен2.вашДОМЕН.com "vless://вашКонфигRAW"
```
